...
function EducationPage() {
  return (
    <div id="education" className="min-h-screen w-full p-6 bg-slate-200 flex flex-col">
      <div className="border-2 border-black bg-white flex flex-col items-center p-10">
        ...
        <div className="h-[1px] bg-black w-10/12 my-8"></div>

        <div className="w-full">
          <div className="flex flex-col p-8">
            <h2 className="text-4xl font-light text-center w-full p-6">
              Actividades Académicas
            </h2>
            <div className="flex flex-wrap justify-center">
              <div className="flex items-center gap-4 p-6 w-full md:w-1/2 lg:w-1/4">
                <span className="text-3xl font-light text-center h-full w-full border-r-2">
                  01
                </span>
                <div className="h-full">
                  <h3 className="text-xl font-semibold">Memoria de Título</h3>
                  <p className="text-lg font-light">
                    Desarrollé un prototipo de dashboard interactivo en React con
                    Highcharts para monitorear la adherencia al tratamiento
                    farmacológico de pacientes.
                  </p>
                  <div className="flex flex-wrap gap-4 pt-2">
                    <CustomChip
                      label="JavaScript"
                      bgColor="bg-colorJavaScript"
                      textColor="text-black"
                    />
                    <CustomChip
                      label="React"
                      bgColor="bg-colorReact"
              ...
              <div className="flex items-center gap-4 p-6 w-full md:w-1/2 lg:w-1/4">
                ...
                <div className="h-full">
                  ...
                  <p className="text-lg font-light">
                    Creación de una base de datos pensada en un negocio o almacén
                    de barrio.
                  </p>
                  <div className="flex flex-wrap gap-4 pt-2">
              ...
              <div className="flex items-center gap-4 p-6 w-full md:w-1/2 lg:w-1/4">
                ...
                <div className="h-full">
                  ...
                  <p className="text-lg font-light">
                    Desarrollo de un sistema de creación de encuestas utilizando
                    Flask.
                  </p>
                  <div className="flex flex-wrap gap-4 pt-2">
              ...
              <div className="flex items-center gap-4 p-6 w-full md:w-1/2 lg:w-1/4">
                ...
                <div className="h-full">
                  ...
                  <p className="text-lg font-light">
                    Desarrollé una aplicación móvil en Flutter para visualizar
                    la disponibilidad de espacios en estacionamientos.
                  </p>
                  <div className="flex flex-wrap gap-4 pt-2">
